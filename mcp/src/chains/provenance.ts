...
export const PROVENANCE: ChainProvenance[] = [
  {
    ...
    contracts: [
      ...
      },
      {
        ...
        note: 'Ours: the same Solidity contract that runs on Arc testnet, Robinhood Chain and Arbitrum One. dailyCap 1 USDC, autoApproveMax 0.25 USDC, a 7-day session key. Dust on purpose; the caps are the product.',
      },
      {
    ...
    artifacts: [
      ...
      },
      {
        ...
        note: '930785 gas, 0.1191 USDC. Session key set to expire 2026-09-23 (tx 0x6614754b), funded with 0.03 USDC (tx 0x7293cf6a).',
      },
      {
        kind: 'settlement',
      ...
      },
      {
        ...
        note: 'The buyer signed and paid no gas; we broadcast. 87165 gas at 169.75 gwei, exactly 0.0148 USDC, and the receipt carries the matching 21000-unit USDC Transfer from the buyer to the receiving address. This measurement set the disclosed fee (0.03). The first attempt was refused before broadcast by our own gas ceiling, which was denominated in ether; the ceiling is now per gas unit.',
      },
    ],
    caveats: [
      'Every payment recorded here is self-funded: the buyer wallet and the receiving address are both ours, and the receiving address is the account that broadcasts. It is labeled internal and always will be. This is evidence both rails work on Arc Mainnet, not evidence of demand.',
      ...
      'We deployed nothing here except the vault. The registries, USDC, CCTP and Gateway are their authors\' contracts; registration is permissionless.',
      'The block explorer, explorer.arc.io, is described by docs.arc.io as permissioned during a private-mainnet phase, and its API refused anonymous reads on launch day. The links on this page may not open for every reader; every transaction is also readable from any Arc Mainnet RPC.',
      ...
      'Gas moved from about 35 to about 187 gwei over launch day. The fee (0.03 USDC) is 2x the measured settlement and is re-measured if the effective gas price passes about 340 gwei.',
    ],
  },
  {
    chain: 'rhchain',
