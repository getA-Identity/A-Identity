...
const PUBLIC = ['/', '/explorer?q=849980', '/arc', '/stellar', '/algorand', '/check', '/check?q=WHZ74ZGNGZGAVEQZTHESENVP5RTHMEQ4BOUKF7UHWOADQMKXDKAK3FESJE', '/celo-proof', '/proof', '/proof/arc', '/proof/stellar',
