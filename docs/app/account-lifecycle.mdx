...
<Frame caption="The console's own nine-step tour, recorded as it runs: the Overview screen, the five-step setup checklist, the four numbers that matter, the chain list with its live and beta badges, a week of settled USDC, and the activity trail. This is a demo account on Arc testnet with a $50 daily cap and nothing settled yet, so the counters read zero on purpose.">
  <img src="/images/console-tour.gif" alt="Animated walkthrough of the A-Identity console in dark mode, stepping through the overview, the setup checklist, the headline numbers, the chain list, the weekly spend and the activity feed" />
</Frame>
