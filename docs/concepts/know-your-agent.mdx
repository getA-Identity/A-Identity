...
<Frame caption="The card check, as a product. The public Trust Explorer runs the four steps on a real agent: resolve the ERC-8004 identity, read the KYA attestation, score the reputation, then decide. This lookup is on Arc testnet, and the verdict is WARN rather than a pass, because a score of 499 sits in the caution band.">
  <img src="/images/explorer-lookup.png" alt="The Agent Trust Explorer showing a verification pipeline: resolve identity, Know Your Agent, score reputation 499 of 1000, and a WARN decision from the risk engine" />
</Frame>
