...
intent, with no wallet or gas needed on the destination.

A-Identity uses Gateway **permissionlessly, with no Circle API key**.
...
<Steps>
  ...
  <Step title="Sign a burn intent">
    ...
    There is no transaction to send on the destination chain.
  </Step>
