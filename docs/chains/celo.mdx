...
<Note>
  ...
  [/celo-proof](https://a-identity.xyz/celo-proof). The registration itself, with its
  transaction and its caveats, is at [/proof/celo](https://a-identity.xyz/proof/celo).
  Celo Sepolia is **beta**.
</Note>
