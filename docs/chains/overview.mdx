...
| Stellar | `stellar:pubnet` | beta | An `AgentSpendPolicy` Soroban vault holding real Circle USDC under a 1 USDC daily cap. No x402 rail sells here yet, and no ERC-8004: identity would be a Soroban registry plus SEP-10 |
