...
| Arbitrum One | `eip155:42161` | planned | Descriptor only |
...
| Robinhood Chain | Through **our** facilitator, because the chain had none: EIP-3009, buyer pays no gas, and settlement is proven by a receipt carrying the matching Transfer log. |
