  ...
  },
  {
    ...
    "protocols": {
      ...
      "identity": {
        "standard": "did:algo",
        "erc8004Native": false,
        "note": "Same as mainnet: no agent registry found here, no KYA anchoring, passport bridged from an EVM chain. Testnet exists for the payment rail rehearsal, not identity."
      }
    },
    "identity": "did:algo",
    "erc8004Native": false,
